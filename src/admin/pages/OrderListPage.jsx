...
const initialOrders = [
  { id: 101, customer: 'John Doe', date: '2025-07-17', total: 125.00, status: 'Shipped' },
  { id: 102, customer: 'Jane Smith', date: '2025-07-17', total: 90.00, status: 'Processing' },
  { id: 103, customer: 'Peter Jones', date: '2025-07-16', total: 205.00, status: 'Delivered' },
  { id: 104, customer: 'Sarah Brown', date: '2025-07-15', total: 45.50, status: 'Cancelled' },
  { id: 105, customer: 'David Green', date: '2025-07-14', total: 300.00, status: 'Delivered' },
  { id: 106, customer: 'Michael Blue', date: '2025-07-13', total: 75.20, status: 'Shipped' },
  { id: 107, customer: 'Emily White', date: '2025-07-12', total: 110.00, status: 'Processing' },
];
...
const OrderListPage = () => {
  ...
  const statuses = useMemo(() => ['All', ...new Set(initialOrders.map(o => o.status))], []);
      ...
      <div className="table-container">
        <div className="table-controls-bar">
          ...
          <div className="header-right">
            <Link to="/admin/orders/new" className="add-new-btn"><FaPlus /> Add New Order</Link>
          </div>
        </div>
