...
const initialStores = [
  { id: 1, name: 'Main Street Apparel', status: 'Active', owner: 'Jane Doe' },
  { id: 2, name: 'Downtown Kicks', status: 'Active', owner: 'John Smith' },
  { id: 3, name: 'Suburban Style', status: 'Inactive', owner: 'Emily White' },
  { id: 4, name: 'Urban Outfitters', status: 'Active', owner: 'David Green' },
  { id: 5, name: 'Vintage Threads', status: 'Inactive', owner: 'Sarah Brown' },
  { id: 6, name: 'Coastal Gear', status: 'Active', owner: 'Michael Blue' },
  { id: 7, name: 'Mountain High', status: 'Active', owner: 'Jessica Black' },
  { id: 8, name: 'Desert Bloom', status: 'Inactive', owner: 'Chris Gray' },
  { id: 9, name: 'Green Valley Goods', status: 'Active', owner: 'Olivia Red' },
  { id: 10, name: 'Riverfront Emporium', status: 'Active', owner: 'Daniel Yellow' },
  { id: 11, name: 'Bayou Boutique', status: 'Inactive', owner: 'Sophia Purple' },
  { id: 12, name: 'Maple Street Market', status: 'Active', owner: 'James Orange' },
];
...
const StoreListPage = () => {
  ...
  const owners = useMemo(() => ['All', ...new Set(initialStores.map(s => s.owner))], []);
      ...
      <div className="table-container">
        <div className="table-controls-bar">
          ...
          <div className="header-right">
            <Link to="/admin/stores/new" className="add-new-btn"><FaPlus /> Add New Store</Link>
          </div>
        </div>
